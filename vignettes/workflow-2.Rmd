...
Again, too much information. So, for the purpose of this demonstration, we will look at a *subset* of the data, that is only samples from day 4 and the first third of beakers. We do this by providing a pattern to read in only those filenames that match this pattern:
